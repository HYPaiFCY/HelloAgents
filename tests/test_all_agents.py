...
class TestSimpleAgentUsage:
    ...
    def test_basic_conversation(self):
        ...
        llm = HelloAgentsLLM()
        agent = SimpleAgent(
            name="AI助手", llm=llm, system_prompt="你是一个友好的AI助手"
        )
    ...
    def test_with_calculator(self):
        ...
        agent = SimpleAgent(
            name="计算助手", llm=llm, tool_registry=registry, enable_tool_calling=True
        )
...
class TestReActAgentUsage:
    ...
    def test_basic_reasoning(self):
        ...
        agent = ReActAgent(
            name="推理助手", llm=llm, tool_registry=registry, max_steps=3
        )
    ...
    def test_tool_reasoning(self):
        ...
        agent = ReActAgent(
            name="数学助手", llm=llm, tool_registry=registry, max_steps=5
        )
...
class TestReflectionAgentUsage:
    ...
    def test_code_generation(self):
        """场景2: 代码生成与反思"""
        llm = HelloAgentsLLM()
        agent = ReflectionAgent(name="代码助手", llm=llm, max_iterations=2)
...
if __name__ == "__main__":
    ...
    test_agent = TestReActAgentUsage()
    test_agent.test_tool_reasoning()
